...
=============================================================
Script purpose:
	Defines the schema (DDL) for the BRONZE Layer's raw tables.
...
Warnings:
	...
	Data types are deliberately kept wide (e.g., NVARCHAR) to avoid data
	conversion errors, with cleansing deferred to the SILVER layer.
*/
